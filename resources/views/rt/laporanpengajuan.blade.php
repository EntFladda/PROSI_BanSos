    ...
    <div class="card-body">
        ...
        <table class="data-table">
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td><a href="{{ url('/laporanpengajuan/detail/1') }}" class="btn-detail">Detail</a></td>
                <td>Lisa</td>
              ...
              <tr>
                <td>2</td>
                <td><a href="{{ url('/laporanpengajuan/detail/2') }}" class="btn-detail">Detail</a></td>
                <td>Rose</td>
                <td>0100100001001010</td>
                <td>PKH</td>
                <td>Ditolak</td>
              ...
              <tr>
                <td>3</td>
                <td><a href="{{ url('/laporanpengajuan/detail/3') }}" class="btn-detail">Detail</a></td>
                <td>Jisoo</td>
                <td>0100100001001010</td>
                <td>BPNT</td>
                <td>Disetujui</td>
